...
grammar_file = os.path.join(root_path, "Parser/LR1Table/grammars/grammar.pl0")
# grammar_file = os.path.join(root_path, "Parser/LR1Table/grammars/grammar.txt")
...
lr1table_output_dir=os.path.join(root_path,"Parser/LR1TableOutput")
